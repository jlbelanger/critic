...
<div class="form-row">
	...
	<div class="form-input">
		<input id="short_title" maxlength="255" name="short_title" type="text" value="{{ old('short_title', !empty($row) ? $row->short_title : '') }}" />
		@error('short_title')
			<span class="form-error">{{ $message }}</span>
		@enderror
	</div>
...
<div class="form-row">
	...
	<div class="form-input">
		<input data-slug="#title" id="slug" maxlength="255" name="slug" required type="text" value="{{ old('slug', !empty($row) ? $row->slug : '') }}" />
		@error('slug')
			<span class="form-error">{{ $message }}</span>
		@enderror
	</div>
